...
function renderHomeGrid() {
  const grid = document.getElementById('homeRedesignCategories') || document.getElementById('homeGrid');
  if (!grid) return;
  ...
  if (grid.id === 'homeGrid') fitGridColumns(grid, categories.length, 230);
}
...
function renderHomepageMedia() {
  ...
  const c = liveState.heroSettings || {};
  const fallbackHero = 'https://lh3.googleusercontent.com/aida-public/AB6AXuCgJjbAdPWCs2-dx1RT_LvB802m6u7WoeiwG-e5gx8Mq3rDZq10avTfceKid9xuxm8bw-ynOwHp1nDEK-auJjnN5Ra7AJwd5mO75h4J6CSHmtYgqomcn22uYvB8WzsOHGoyA97kkdlKx5crZljvtQ9SHLT6MfUzyJqgT6w3Pr-z63Md9Vl2Kp0aDZZE7wn8pdgHI1Spjr4tOyA64IMaSpe0cwr2m3ZfuaI3cgpDx8JqqfQ7c54wMYE2BX0EFE4xLNZ4aS-cYT_BSQ';
